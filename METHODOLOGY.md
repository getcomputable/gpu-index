...
This section specifies how a referencing contract consumes the index. Using any Index Value to settle or construct a financial product requires a separate written license; see LICENSE-DATA.md Section 2.
