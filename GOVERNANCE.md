...
Panel membership is the parameter; weights within the panel are computed (see
METHODOLOGY.md Part III). Adding or removing a panel provider is a governance
